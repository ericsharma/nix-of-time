    ...
    views = [
      ...
      # ── Light Identification ────────────────────────────────────────────────
      {
        ...
        cards = [
          ...
          {
            type = "tile";
            entity = "switch.dresser_light";
            name = "Dresser Light";
            icon = "mdi:lightbulb";
          }
          {
            type = "tile";
            entity = "switch.work_power_strip_kasa_smart_plug_d375_3";
            name = "Workspace Corner Lamp";
            icon = "mdi:lightbulb";
          }
          {
            type = "tile";
            entity = "switch.work_power_strip_corner_lamp_light";
            name = "Unused (Work Strip Plug)";
          ...
          {
            type = "tile";
            entity = "light.a_c_socket_1";
            name = "AC Socket 1 (?)";
            icon = "mdi:lightbulb-question";
          }
          {
            type = "tile";
            entity = "light.a_c_socket_2";
            name = "AC Socket 2 (?)";
            icon = "mdi:lightbulb-question";
          }
          {
            type = "tile";
            entity = "light.a_c_socket_3";
            name = "AC Socket 3 (?)";
            icon = "mdi:lightbulb-question";
          }
          ...
          {
            type = "tile";
            entity = "switch.tp_link_power_strip_c7b1_plug_5";
            name = "Dining Room Table Lamp";
            icon = "mdi:lightbulb";
          }
        ];
      }
      ...
      # ── Home Lab ────────────────────────────────────────────────────────────
      {
        ...
        cards = [
          ...
          {
            type = "tile";
            entity = "switch.tp_link_power_strip_c7b1_plug_2";
            name = "Router";
            icon = "mdi:router-network";
          }
          {
            type = "tile";
            entity = "switch.tp_link_power_strip_c7b1_plug_3";
            name = "Lab Device 3";
            icon = "mdi:server";
          }
          {
            type = "tile";
            entity = "switch.tp_link_power_strip_c7b1_plug_4";
            name = "gmktek-pve";
            icon = "mdi:server";
          }
          {
            type = "tile";
            entity = "switch.tp_link_power_strip_c7b1_plug_6";
            name = "trigkey-pve";
            icon = "mdi:server";
          }
        ];
      ...
      # ── Air Quality ─────────────────────────────────────────────────────────
      {
        ...
        cards = [
          {
            type = "tile";
            entity = "sensor.airgradient_pm2_5";
            name = "PM2.5";
            icon = "mdi:blur";
          }
          {
            type = "tile";
            entity = "sensor.airgradient_carbon_dioxide";
            name = "CO₂";
          ...
          {
            type = "tile";
            entity = "sensor.airgradient_nox_index";
            name = "NOx Index";
            icon = "mdi:smog";
          }
        ];
